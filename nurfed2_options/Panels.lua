...
do
	...
	local function Constructor()
		...
		local button = CreateFrame("Button", "AceGUI-3.0 Nurfed2KeybindingButton"..num, frame, "KeybindingTemplate")
		print("constructor!")
		local self = {}
		self.type = Type
		self.num = num
		...
		msg:SetText("asdfsdfPress a key to bind, ESC to clear the binding or click the button again to cancel")
		msgframe.msg = msg
